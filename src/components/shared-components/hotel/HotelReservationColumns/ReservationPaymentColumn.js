            ...
            <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24} style={{ textAlign: 'left' }}>
                <Row gutter={[0, 0]}>
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24} style={{ marginBottom: '0.225rem' }}>
                        <Text style={{ fontSize: '0.845rem', margin: '0 auto', fontWeight: 'bold' }}>
                    ...
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                        <Text style={{ fontSize: '0.785rem', margin: '0 auto' }}>
                    ...
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                        <Text style={{ fontSize: '0.805rem', margin: '0 auto', fontWeight: 'bold' }}>결제일 정보</Text>
                    </Col>
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                        <Text style={{ fontSize: '0.775rem', margin: '0 auto', fontWeight: 'bold' }}>• 결제일 : </Text>
                        <Text style={{ fontSize: '0.765rem'}}>{Utils.getDateTimeKr(props.paymentDate)}</Text>
                    </Col>
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                        <Text style={{ fontSize: '0.775rem', margin: '0 auto', fontWeight: 'bold' }}>• 호텔 취소수수료 발생일 : </Text>
                        <Text style={{ fontSize: '0.765rem'}}>{Utils.getDateTimeKr(props?.reservationHotel.cancelPenaltyStartDate)}</Text>
                    </Col>
                </Row>
            </Col>
        </>
